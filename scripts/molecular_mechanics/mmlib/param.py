...
_VAN_DER_WAALS_PARAMETERS = {
    ...
    'LI': (1.1370, 0.0183), 'IP': (1.8680, 0.00277), 'MG': (1.1370, 0.0183),
    ...
    'SH': (2.0000, 0.2500), 'ZN' : (1.3870, 0.0157), 'NA': (1.8240, 0.1700),
    ...
    'CL':(1.7500, 0.0610),'BR':(1.7500, 0.0610) }
...
def GetVdwParam(at_type):
  ...
  """
  if at_type.upper() in _VAN_DER_WAALS_PARAMETERS:
    return _VAN_DER_WAALS_PARAMETERS[at_type.upper()]
  else:
